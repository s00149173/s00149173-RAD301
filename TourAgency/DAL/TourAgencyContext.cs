...
namespace TourAgency.DAL
{
    ...
    public class TourAgencyInitializer : DropCreateDatabaseAlways<TourAgencyContext>
    {
        protected override void Seed(TourAgencyContext context)
        {
            ...
            var legs = new List<Leg> 
            {
                ...
                new Leg {StartLocation = "NewCastle", EndLocation="Liverpool", StartDate=new DateTime(2014,01,26), EndDate=new DateTime(2014,01,27), TripId=2},
                new Leg {StartLocation = "Liverpool", EndLocation="Bristol", StartDate=new DateTime(2014,01,28), EndDate=new DateTime(2014,01,28), TripId=2},
                ...
                new Leg {StartLocation = "Nancy", EndLocation="Besançon", StartDate=new DateTime(2014,05,31), EndDate=new DateTime(2014,06,01), TripId=3},
                new Leg {StartLocation = "Besançon", EndLocation="Dijon", StartDate=new DateTime(2014,06,02), EndDate=new DateTime(2014,06,03), TripId=3},
                new Leg {StartLocation = "Dijon", EndLocation="Orleans", StartDate=new DateTime(2014,06,04), EndDate=new DateTime(2014,06,06), TripId=3},
                ...
                new Leg {StartLocation = "Valladolid", EndLocation="Madrid", StartDate=new DateTime(2014,06,21), EndDate=new DateTime(2014,06,22), TripId=4},
            ...
            var guestOnLegs = new List<GuestsOnLegs>
            {
                ...
                //new GuestsOnLegs{LegId=23, GuestId=18},
                //new GuestsOnLegs{LegId=23, GuestId=19},
                //new GuestsOnLegs{LegId=23, GuestId=20},
                //new GuestsOnLegs{LegId=23, GuestId=21},
                new GuestsOnLegs{LegId=23, GuestId=22},
